...
class AsyncAgent:
    ...
    async def run_stream(
        ...
        **kwargs
        ...
        system_prompt = (await self.__format_system_prompt(dependency, self.llm_system_prompt)).strip()
        if system_prompt:
        ...
        while logical_steps < max_steps:
            ...
            stream = await self.generate_stream_completion(
    ...
    async def generate_stream_completion(self, conversation: list, temperature: float, **kwargs):
